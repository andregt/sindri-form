 ...
 *
 * Modificado por André Timermann em 01/06/2016 para compabitilidade com webpack
 *
 * @version v1.4.0
...
require('../chosen/chosen_v1.5.1/chosen.jquery.js');

module.exports = angular.module('localytics.directives', []).name;
