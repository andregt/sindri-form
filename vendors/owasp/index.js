/**
 * Created by André Timermann on 09/06/16.
 *
 *
 */
'use strict';
...
/* globals define
 *
 * Versão Traduzida, Modificada Por André Timermann
 * */
            ...
            required: [
                ...
                function (password) {
                    if (/(.)\1{2,}/.test(password)) {
                        return 'A senha não pode conter seqüências de três ou mais caracteres repetidos.';
                    }
                }
            ],
